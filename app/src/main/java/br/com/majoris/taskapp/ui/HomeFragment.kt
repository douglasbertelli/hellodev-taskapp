...
import br.com.majoris.taskapp.ui.adapter.ViewPagerAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun initTabs() {
        ...
        TabLayoutMediator(binding.tabs, binding.viewPager) { tab, position -> tab.text = getString(pageAdapter.getTitle(position))
        }.attach()
